...
export function OverviewPage() {
  ...
  return (
    <div className="fade-in relative isolate max-w-5xl">
      <HeroPattern />
      <header className="mb-14">
        ...
        <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
          Interactive documentation reference for bounded contexts, modules, endpoints, use-cases, domain events, and their relationships.
        </p>
