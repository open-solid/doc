...
export function SubscriberCard({ item, color, moduleName, index }: SubscriberCardProps) {
  ...
  return (
    <article className="item-card rounded-lg p-5 bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50" style={{ '--card-accent': 'rgb(244 63 94)' } as React.CSSProperties}>
